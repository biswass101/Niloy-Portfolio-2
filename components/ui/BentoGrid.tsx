    ...
    <div
      className={cn(
        `group/bento relative shadow-input row-span-1 overflow-hidden
         flex flex-col justify-between space-y-4 rounded-xl border border-white/[0.1]
         transition
         ${
           id === 1
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["React.js", "Next.js", "TypeScript"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                <span className="py-4 px-3 rounded-lg text-center bg-[#10132E]"/>
                {["Vue.js", "Nuxt.js", "Node.js"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100
                  rounded-lg text-center bg-[#10132E]"
